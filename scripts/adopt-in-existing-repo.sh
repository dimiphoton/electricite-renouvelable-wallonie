...
mkdir -p brief
cp -n "$TEMPLATE_DIR/brief/objectif.md" brief/

mkdir -p pictures/readme pictures/experiments pictures/presentations docs
touch pictures/readme/.gitkeep pictures/experiments/.gitkeep pictures/presentations/.gitkeep
